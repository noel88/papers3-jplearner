...
void ReadScreen::showToast(const char* message) {
    int toastW = 200;
    int toastH = 50;
...
// ============================================
void ReadScreen::showDictionaryPopup(const String& word) {
...
void ReadScreen::drawDictionaryEntry(const DictEntry& entry, int y) {
    int popupW = 450;
    int popupX = (SCREEN_WIDTH - popupW) / 2;
